...
if __name__ == "__main__":
    ...
    # Print full GMT date and time
    print("Full GMT Date and Time:", now.strftime("%Y-%m-%d-%H:%M:%S"))
    print("Full GMT Date and Time:", datetime.now(timezone.utc).strftime("%d%m%Y%H%M%S"))
